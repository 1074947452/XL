...
class ScamperApp(QWidget):
    def __init__(self):
        ...
        self.initUI()
        self.messages = []
        ask = "你好，我现在正在进行SCAMPER创新的过程中，请帮我介绍一下，此后我将询问你相关问题！"
        star_ask_thread = Thread(target=self.askllm, args=(ask,))
        star_ask_thread.daemon = True
        star_ask_thread.start()
    ...
    def initUI(self):
        ...
        self.ask_ai.setPlaceholderText("请输入你的问题，首次生成可能较慢!!!")
    ...
    def generate_element_from_llm(self):
        ...
        if q == "":
            ...
            generate_example_thread.daemon = True
    ...
    def show_summary(self):
        ...
        dialog.exec_()
        self.close()
    def askllm(self,ask,role ='user'):

        self.messages.append(Message(role=role, content=ask, images=None, tool_calls=None))
